...
class Dejavu(object):
    ...
    def align_matches(self, matches):
        """
            ...
            [old] Returns a dictionary with match information.
            [updated] Returns a list of dictionaries with match information.
        """
        # align by diffs
        diff_counter = {}

        # Mark Koh - Initialize song dict
        largest = {}
        largest_count = {}
        song_ids = {}
        for tup in matches:
            sid, diff = tup
            # TODO: What is diff_counter?  Are we using it right for multiple matches
            ...
            # Mark Koh - Check song dict for song
            # TODO: Rethink longest count - we need to handle negative differences?
            if sid in song_ids:
                song_ids[sid] += 1
            else:
                song_ids[sid] = 0
            ...
            # Update the largest match for a given song
        ...
        # Return none if we had no matches
        if len(song_ids) < 1:
            return None
        ...
        for song_id in song_ids:
            ...
            song = {
                ...
                Dejavu.CONFIDENCE: largest_count[song_id],
